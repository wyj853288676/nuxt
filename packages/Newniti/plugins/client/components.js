...
const myDrag = require("@/assets/js/myDrag.js");


Vue.component('nwt-dashboard', dashboard);
Vue.component('nwt-compass', compass);
Vue.component('nwt-main-container', mainContainer);
Vue.component('nwt-sidebar', sidebar);
Vue.component('nwt-header', header);
Vue.component('nwt-clock', clock);


Vue.component('ui-config', uiConfig);
Vue.component('price-number', priceNumber);
Vue.component('nwt-light', light);
